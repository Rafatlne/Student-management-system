...
include_once($filepath.'/../config/database.php'); 
    ...
    try{
        ...
        //insert query
        $query = "INSERT INTO studentxcourse SET s_id=:s_id, c_id=:c_id";
    ...
    try{
    	$query2 = "SELECT distinct s_id from student";
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
    <table class='table table-hover table-responsive table-bordered'>
    	...
    	<td>
    	<select name="s_id">
    		<option>---Select s_id---</option>
    		<?php foreach ($student as $s_id) {
    			
    		 ?>
    		<option> <?php echo $s_id["s_id"]; ?></option>
    		<?php } ?>
    	</select>
    </label>
            </td>
